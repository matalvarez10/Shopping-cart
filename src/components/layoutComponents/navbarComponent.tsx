...
const NavBarComponent = () => {
  ...
  return (
    <nav className="absolute md:fixed w-full flex flex-row gap-3 h-20 md:justify-between items-center top-0 text-white  px-5 lg:px-24 font-montserrat text-xs md:text-sm font-light bg-gray-900 uppercase z-10">
      <Link to="/">
      ...
      <Link to="/products/cart" className="text-xl md:text-3xl flex flex-row justify-center items-center gap-3">
        <FaBagShopping />
