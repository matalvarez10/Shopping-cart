const NewsletterComponent = () => {
  ...
  return (
    <section className="flex flex-col justify-center items-center w-[50%] mx-auto gap-3 py-7">
      <img src={emailImg} alt="email-vector" className="h-[300px] rounded-full shadow-lg" />
